...
SYSTEM = f"You are a coding agent at {os.getcwd()}.The shell is {platform.system()} ({'cmd.exe' if platform.system()=='Windows' else 'bash'}). Use tools to solve tasks. Act, don't explain."
